...
if len(sys.argv) < 2:
    print("Usage: python train_mlm.py data/train_sentences.txt [data/dev_sentences.txt]")
    exit()
...
output_dir = "models/{}-{}".format(model_name.replace("/", "_"), datetime.now().strftime("%Y-%m-%d_%H-%M-%S"))
